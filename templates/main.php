    ...
    <ul class="promo__list">
        <?php foreach ($categories as $category): ?>
            <li class="promo__item promo__item--<?=$category['symbolic_code']; ?>">
                <a class="promo__link" href=/category.php?category=<?=$category['symbolic_code']; ?>><?=$category['title']; ?></a>
            </li>
        <?php endforeach; ?>
    </ul>
</section>
        ...
        <?php foreach ($ads as $ad): ?>
            <li class="lots__item lot" >
                ...
                <div class="lot__info">
                    ...
                    <h3 class="lot__title"><a class="text-link" href="/lot.php?id=<?=$ad['lotId']; ?>"><?=$ad['title']; ?></a></h3>
