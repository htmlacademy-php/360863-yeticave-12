    ...
    --invalid -->
        ...
        <div class="form__item <?php if (!empty($errors['password'])) {
            ...
            <input id="password" type="password" name="password" placeholder="Введите пароль"
                   value="<?php if (!empty($safeData['password'])) {
                       echo $safeData['password'];
                   } ?>">
        ...
        <div class="form__item <?php if (!empty($errors['name'])) {
            ...
            <input id="name" type="text" name="name" placeholder="Введите имя"
                   value="<?php if (!empty($safeData['name'])) {
                       echo $safeData['name'];
                   } ?>">
        ...
        <div class="form__item <?php if (!empty($errors['message'])) {
            ...
            <textarea id="message" name="message"
                      placeholder="Напишите как с вами связаться"><?php if (!empty($safeData['message'])) {
